...
class Grandma extends React.Component {
  handleSelect = () => {
    ...
    if (char === 'cap') {
      return <img style={{ width: '200px', marginBottom: '-20px' }} src={cap} />
    } else if (char === 'strange') {
      return <img style={{ width: '200px', marginBottom: '-20px' }} src={strange} />
    } else if (char === 'ironman') {
      return <img style={{ width: '200px', marginBottom: '-20px' }} src={ironman} />
    } else if (char === 'thor') {
      return <img style={{ width: '200px', marginBottom: '-20px' }} src={thor} />
    } else if (char === 'spiderman') {
      return <img style={{ width: '200px', marginBottom: '-20px' }} src={spiderman} />
    }
  }
  render() {
    return (
